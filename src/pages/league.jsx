        ...
        <Box sx={{
            ...
            <Box sx={{
                ...
                <Box sx={{ textAlign: 'center', color: 'white' }}>
                    <Typography component="h1" sx={{ fontFamily: 'Montserrat', fontWeight: 900, fontSize: { xs: '2rem', md: '3rem' }, mb: { xs: 3, md: 2 }, textTransform: 'uppercase', lineHeight: 1.2 }}>
                        ABOUT DC SCHOOLS LEAGUE
                    </Typography>
                    <Typography sx={{ fontFamily: 'Montserrat', fontSize: { xs: '1.1rem', md: '1.2rem' }, mb: 4 }}>
                    ...
                    <Box sx={{ display: 'flex', flexDirection: 'column', gap: { xs: 3, md: 0 } }}>
                        <Typography sx={{ fontFamily: 'Montserrat', fontSize: { xs: '0.9rem', md: '1rem' }, lineHeight: { xs: 1.7, md: 1.8 }, maxWidth: '900px', mx: 'auto', mb: { xs: 0, md: 3 } }}>
                        ...
                        <Typography sx={{ fontFamily: 'Montserrat', fontSize: { xs: '0.9rem', md: '1rem' }, lineHeight: { xs: 1.7, md: 1.8 }, maxWidth: '900px', mx: 'auto' }}>
